  ...
  full_onc_df <-
    ...
    mutate(
      ...
      new_enroll = Hmisc::cut2(x = enrollment, cuts = c(10, 50, 100, 500, 1000, Inf)),
          new_enroll = fct_relevel(new_enroll, "[ 100, 500)"),
...
full_onc_df$new_enroll <- relevel(full_onc_df$new_enroll, ref = "[ 100, 500)")
...
#Relevel to reference groups
surg_onc_df$new_enroll <- relevel(surg_onc_df$new_enroll, ref = "[ 100, 500)")      
...
cox_results_only_surg_early_discontinuation <- do_cox_pooling(only_surg_cox_pooled, TRUE)

cox_results_full_were_results_reported <- do_cox_pooling(full_cox_pooled, FALSE)
cox_results_only_surg_were_results_reported <- do_cox_pooling(only_surg_cox_pooled, FALSE)
